...
* [`0`, `0-debian-11`, `0.4.7`, `0.4.7-debian-11-r20`, `latest` (0/debian-11/Dockerfile)](https://github.com/bitnami/bitnami-docker-nginx-intel/blob/0.4.7-debian-11-r20/0/debian-11/Dockerfile)
...
```console
$ docker build -t bitnami/nginx-intel:latest 'https://github.com/bitnami/bitnami-docker-nginx-intel.git#master:0/debian-11'
```
